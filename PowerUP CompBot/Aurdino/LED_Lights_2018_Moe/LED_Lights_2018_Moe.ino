...
#define D_PIXEL_CNT_1  58
#define D_BUFF_SIZE     4
int counter = 0;
// Constructors
Adafruit_NeoPixel strip_1 = Adafruit_NeoPixel(14, D_STRIP_1_PIN, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip_2 = Adafruit_NeoPixel(D_PIXEL_CNT_1, D_STRIP_2_PIN, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip_3 = Adafruit_NeoPixel(23, D_STRIP_3_PIN, NEO_GRB + NEO_KHZ800);
...
pinMode(9, INPUT);
pinMode(10, INPUT);
pinMode(11, INPUT); //Left Limit Switch
